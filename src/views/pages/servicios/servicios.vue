      ...
      >
        <form class="needs-validation" @submit.prevent="formSubmit">
          <div class="row">
            <div class="col-12 col-lg-6">
              <div class="mb-3">
                ...
                <span class="text-danger" v-if="servicioexist"
                  >servicio ya creado.</span
                >
              </div>
            </div>
            <div class="col-12 col-lg-6">
              <div class="mb-3">
                ...
                <input
                  ...
                  class="form-control"
                  :class="{
                    'is-invalid': submitted && $v.form.intervalo.$error,
                  }"
                />
          ...
          <div class="row">
            <div class="col-12 col-lg-6">
              <div class="mb-3">
                <label for="precio_particular">Precio Particular</label>
                <input
                  id="precio_particular"
                  v-model="form.precio_particular"
                  type="number"
                  class="form-control"
                  :class="{
                    'is-invalid': submitted && $v.form.precio_particular.$error,
                  }"
                />

                <div
                  v-if="submitted && $v.form.precio_particular.$error"
                  class="invalid-feedback"
                >
                  <span v-if="!$v.form.precio_particular.required"
                    >El Precio Particular es requerido.</span
                  >
                </div>
            ...
            <div class="col-12 col-lg-6">
              <div class="mb-3">
                <label for="precio_fonasa">Precio Fonasa</label>
                <input
                  id="precio_fonasa"
                  v-model="form.precio_fonasa"
                  type="number"
                  class="form-control"
          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-6">
              <div class="mb-3">
                <label for="precio_isapre">Precio Isapre</label>
                <input
                  id="precio_isapre"
                  v-model="form.precio_isapre"
                  type="number"
                  class="form-control"
